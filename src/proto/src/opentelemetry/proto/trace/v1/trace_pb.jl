# Autogenerated using ProtoBuf.jl v1.1.1 on 2025-04-15T13:50:48.202
# original file: /var/folders/z8/3_xmt_5d7vs6hdclc083pvlh0000gn/T/jl_mRWRro/opentelemetry-proto-1.5.0/opentelemetry/proto/trace/v1/trace.proto (proto3 syntax)
...
export var"Span.SpanKind", var"Span.Event", var"Status.StatusCode", var"Span.Link"
export SpanFlags, Status, Span, ScopeSpans, ResourceSpans, TracesData
...
struct var"Span.Event" <: AbstractProtoBufMessage
...
struct var"Span.Link" <: AbstractProtoBufMessage
...
PB.default_values(::Type{var"Span.Link"}) = (;trace_id = UInt8[], span_id = UInt8[], trace_state = "", attributes = Vector{opentelemetry.proto.common.v1.KeyValue}(), dropped_attributes_count = zero(UInt32), flags = zero(UInt32))
PB.field_numbers(::Type{var"Span.Link"}) = (;trace_id = 1, span_id = 2, trace_state = 3, attributes = 4, dropped_attributes_count = 5, flags = 6)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Span.Link"})
    ...
    return var"Span.Link"(trace_id, span_id, trace_state, attributes[], dropped_attributes_count, flags)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"Span.Link")
    ...
    x.flags != zero(UInt32) && PB.encode(e, 6, x.flags, Val{:fixed})
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"Span.Link")
    ...
    x.flags != zero(UInt32) && (encoded_size += PB._encoded_size(x.flags, 6, Val{:fixed}))
    return encoded_size
end

@enumx SpanFlags SPAN_FLAGS_DO_NOT_USE=0 SPAN_FLAGS_TRACE_FLAGS_MASK=255 SPAN_FLAGS_CONTEXT_HAS_IS_REMOTE_MASK=256 SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK=512

struct Status <: AbstractProtoBufMessage
    message::String
...
struct Span <: AbstractProtoBufMessage
    trace_id::Vector{UInt8}
    span_id::Vector{UInt8}
    trace_state::String
...
PB.default_values(::Type{Span}) = (;trace_id = UInt8[], span_id = UInt8[], trace_state = "", parent_span_id = UInt8[], flags = zero(UInt32), name = "", kind = var"Span.SpanKind".SPAN_KIND_UNSPECIFIED, start_time_unix_nano = zero(UInt64), end_time_unix_nano = zero(UInt64), attributes = Vector{opentelemetry.proto.common.v1.KeyValue}(), dropped_attributes_count = zero(UInt32), events = Vector{var"Span.Event"}(), dropped_events_count = zero(UInt32), links = Vector{var"Span.Link"}(), dropped_links_count = zero(UInt32), status = nothing)
PB.field_numbers(::Type{Span}) = (;trace_id = 1, span_id = 2, trace_state = 3, parent_span_id = 4, flags = 16, name = 5, kind = 6, start_time_unix_nano = 7, end_time_unix_nano = 8, attributes = 9, dropped_attributes_count = 10, events = 11, dropped_events_count = 12, links = 13, dropped_links_count = 14, status = 15)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Span})
    ...
    return Span(trace_id, span_id, trace_state, parent_span_id, flags, name, kind, start_time_unix_nano, end_time_unix_nano, attributes[], dropped_attributes_count, events[], dropped_events_count, links[], dropped_links_count, status[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::Span)
    ...
    x.flags != zero(UInt32) && PB.encode(e, 16, x.flags, Val{:fixed})
...
function PB._encoded_size(x::Span)
    ...
    x.flags != zero(UInt32) && (encoded_size += PB._encoded_size(x.flags, 16, Val{:fixed}))
...
struct ScopeSpans <: AbstractProtoBufMessage
...
struct ResourceSpans <: AbstractProtoBufMessage
...
struct TracesData <: AbstractProtoBufMessage
