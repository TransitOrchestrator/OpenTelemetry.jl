# Autogenerated using ProtoBuf.jl v1.1.1 on 2025-04-15T13:50:48.205
# original file: /var/folders/z8/3_xmt_5d7vs6hdclc083pvlh0000gn/T/jl_mRWRro/opentelemetry-proto-1.5.0/opentelemetry/proto/metrics/v1/metrics.proto (proto3 syntax)
...
struct Exemplar <: AbstractProtoBufMessage
...
@enumx DataPointFlags DATA_POINT_FLAGS_DO_NOT_USE=0 DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK=1
...
struct var"ExponentialHistogramDataPoint.Buckets" <: AbstractProtoBufMessage
    offset::Int32
...
struct var"SummaryDataPoint.ValueAtQuantile" <: AbstractProtoBufMessage
    quantile::Float64
    value::Float64
end
...
struct NumberDataPoint <: AbstractProtoBufMessage
...
struct HistogramDataPoint <: AbstractProtoBufMessage
    attributes::Vector{opentelemetry.proto.common.v1.KeyValue}
    start_time_unix_nano::UInt64
    time_unix_nano::UInt64
    count::UInt64
...
struct ExponentialHistogramDataPoint <: AbstractProtoBufMessage
    attributes::Vector{opentelemetry.proto.common.v1.KeyValue}
    start_time_unix_nano::UInt64
    time_unix_nano::UInt64
    count::UInt64
...
PB.default_values(::Type{ExponentialHistogramDataPoint}) = (;attributes = Vector{opentelemetry.proto.common.v1.KeyValue}(), start_time_unix_nano = zero(UInt64), time_unix_nano = zero(UInt64), count = zero(UInt64), sum = zero(Float64), scale = zero(Int32), zero_count = zero(UInt64), positive = nothing, negative = nothing, flags = zero(UInt32), exemplars = Vector{Exemplar}(), min = zero(Float64), max = zero(Float64), zero_threshold = zero(Float64))
PB.field_numbers(::Type{ExponentialHistogramDataPoint}) = (;attributes = 1, start_time_unix_nano = 2, time_unix_nano = 3, count = 4, sum = 5, scale = 6, zero_count = 7, positive = 8, negative = 9, flags = 10, exemplars = 11, min = 12, max = 13, zero_threshold = 14)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExponentialHistogramDataPoint})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 14
            zero_threshold = PB.decode(d, Float64)
        else
            PB.skip(d, wire_type)
        end
    end
    return ExponentialHistogramDataPoint(attributes[], start_time_unix_nano, time_unix_nano, count, sum, scale, zero_count, positive[], negative[], flags, exemplars[], min, max, zero_threshold)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::ExponentialHistogramDataPoint)
    ...
    x.zero_threshold !== zero(Float64) && PB.encode(e, 14, x.zero_threshold)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ExponentialHistogramDataPoint)
    ...
    x.zero_threshold !== zero(Float64) && (encoded_size += PB._encoded_size(x.zero_threshold, 14))
    return encoded_size
end

struct SummaryDataPoint <: AbstractProtoBufMessage
    attributes::Vector{opentelemetry.proto.common.v1.KeyValue}
    start_time_unix_nano::UInt64
    time_unix_nano::UInt64
    count::UInt64
...
struct Gauge <: AbstractProtoBufMessage
...
struct Sum <: AbstractProtoBufMessage
    data_points::Vector{NumberDataPoint}
...
struct Histogram <: AbstractProtoBufMessage
...
struct ExponentialHistogram <: AbstractProtoBufMessage
...
struct Summary <: AbstractProtoBufMessage
...
struct Metric <: AbstractProtoBufMessage
    name::String
    description::String
    unit::String
    data::Union{Nothing,OneOf{<:Union{Gauge,Sum,Histogram,ExponentialHistogram,Summary}}}
    metadata::Vector{opentelemetry.proto.common.v1.KeyValue}
end
...
PB.default_values(::Type{Metric}) = (;name = "", description = "", unit = "", gauge = nothing, sum = nothing, histogram = nothing, exponential_histogram = nothing, summary = nothing, metadata = Vector{opentelemetry.proto.common.v1.KeyValue}())
PB.field_numbers(::Type{Metric}) = (;name = 1, description = 2, unit = 3, gauge = 5, sum = 7, histogram = 9, exponential_histogram = 10, summary = 11, metadata = 12)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Metric})
    ...
    unit = ""
    data = nothing
    metadata = PB.BufferedVector{opentelemetry.proto.common.v1.KeyValue}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
    ...
    return Metric(name, description, unit, data, metadata[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::Metric)
    ...
    !isempty(x.metadata) && PB.encode(e, 12, x.metadata)
    return position(e.io) - initpos
end
function PB._encoded_size(x::Metric)
    ...
    !isempty(x.metadata) && (encoded_size += PB._encoded_size(x.metadata, 12))
    return encoded_size
end

struct ScopeMetrics <: AbstractProtoBufMessage
...
struct ResourceMetrics <: AbstractProtoBufMessage
...
struct MetricsData <: AbstractProtoBufMessage
