# Autogenerated using ProtoBuf.jl v1.1.1 on 2025-04-15T13:50:48.208
# original file: /var/folders/z8/3_xmt_5d7vs6hdclc083pvlh0000gn/T/jl_mRWRro/opentelemetry-proto-1.5.0/opentelemetry/proto/common/v1/common.proto (proto3 syntax)
...
abstract type var"##Abstract#ArrayValue" <: AbstractProtoBufMessage end
abstract type var"##Abstract#InstrumentationScope" <: AbstractProtoBufMessage end
abstract type var"##Abstract#KeyValueList" <: AbstractProtoBufMessage end
abstract type var"##Abstract#AnyValue" <: AbstractProtoBufMessage end
abstract type var"##Abstract#KeyValue" <: AbstractProtoBufMessage end
